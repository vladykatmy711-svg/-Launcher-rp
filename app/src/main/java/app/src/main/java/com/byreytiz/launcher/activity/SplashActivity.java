...
import com.byreytiz.launcher.adapter.NewsAdapter;
import com.byreytiz.launcher.model.News;

import com.byreytiz.launcher.adapter.ServersAdapter;
    ...
    private void startLauncher()
    {
		...
		NotificationCompat.Builder builder =
				new NotificationCompat.Builder(SplashActivity.this, CHANNEL_ID)
						...
						.setContentTitle("BLACK RUSSIA")
						.setContentText("Вводи промокод #yаngаy и получай бонус")
